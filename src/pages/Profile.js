                ...
                <div className='profile_info'>
                    ...
                    <div className='first_sec'>
                        <div className='user_box'>
                            ...
                            <div className='user_avatar' style={{backgroundImage: userInf.image_url}}><div className='user_name'>{userInf.username}</div></div>
                        </div>
                    ...
                    <div className='third_sec'>
                        <div className='about_tit'><span className='texts_starter'></span>درباره من</div>
                                        ...
                                        user_questions_2.map((question, index) => 
                                            <div key={index} className='user_q'>
                                                ...
                                                <div className='user_q_tags'>
                                                    {
                                                        question.tags.map((tag, index) => <div key={index} className='tag'>{tag}</div>)
                                                    }
                                                </div>
                                            </div>    
                                        )
